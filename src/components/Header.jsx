        ...
        {isMobileMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-white">
              ...
              <button onClick={() => { setShowConsultationForm(true); setIsMobileMenuOpen(false); }} className="block w-full text-left px-3 py-2 text-gray-700 hover:text-blue-800">Free Consultation</button>
            </div>
          </div>
        )}
      </div>
